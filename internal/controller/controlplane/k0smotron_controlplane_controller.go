...
func (c *K0smotronController) getKmcScope(ctx context.Context, kcp *cpv1beta1.K0smotronControlPlane) (*kmcScope, error) {
	...
	if kcp.Spec.HostingClusterKubeconfigRef != nil {
		var err error
		kmcScope.client, kmcScope.clientSet, kmcScope.restConfig, err = util.GetKmcClientFromClusterPrLubeconfigSecret(ctx, c.Client, kcp.Spec.HostingClusterKubeconfigRef)
		if err != nil {
